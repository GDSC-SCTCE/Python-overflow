...
def wishMe():
    ...
    if hour>=0 and hour<12:
        speak("Good morning Pranav!")

    elif hour>=12 and hour<18:
        speak("Good afternoon Pranav!")
...
def sendEmail(to,content):
    ...
    server.ehlo()
    server.starttls()
    server.login('testbots.py@gmail.com','pranav123')
    server.sendmail('testbots.py@gmail.com',to,content)
    server.close()
    ...
    #logic for executing tasks based on query
        if 'wikipedia' in query:
            ...
            try:
                ...
                content = takeCommand()
                to = "pranavajay2002@gmail.com"
                sendEmail(to,content)
                speak("Email has been sent")

            except Exception as e:
                print(e)
                speak("Sorry pranav i was unabvle to sent the mail")
            ...
            speak('Hello , pranav what can i do for you, today')
